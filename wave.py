...
class TimeSlotTrigger(threading.Thread):
    ...
    def run(self):
        ...
        while (1):
            ...
            if(self.globalValues["growing"]==True):
                self.globalValues["attackerRequestsPerTimeSlot"] = self.globalValues["attackerRequestsPerTimeSlot"] + 6
                if(self.globalValues["attackerRequestsPerTimeSlot"]>=156):
                    self.globalValues["growing"]=False

            else:
                self.globalValues["attackerRequestsPerTimeSlot"] = self.globalValues["attackerRequestsPerTimeSlot"] - 6
                if(self.globalValues["attackerRequestsPerTimeSlot"]<=56):
                    self.globalValues["growing"]=True
